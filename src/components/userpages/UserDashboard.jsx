...
//             <svg viewBox="0 0 24 24" className="text-gray-600 w-16 h-16 mx-auto my-6">
...
//                 <a href={`${id}`} className="px-12 bg-gray-600 hover:bg-gray-500 text-white font-semibold py-3">
//                   GO BACK
//                 </a>
//               </div>
//             </div>
  ...
  return (
    <Layout title={"User Pond Details"}>
      <div className='flex'>
        ...
        <div className='flex flex-col w-full  '>
          <div className="p-4 w-full flex md:flex-row  flex-col-reverse md:justify-between md:gap-5 gap-0 h-[50%]">
            <div className='md:w-8/12 flex flex-col relative'>
              <div id="map" className='md:h-full z-0 h-80'>
              </div>
              <button className='absolute bg-white p-2 text-black rounded-sm border border-black z-1 right-0 md:right-2 top-2' onClick={toggleSatelliteView}>Map Views</button>
          ...
          <div className="relative inline-block text-left left-8 top-10">
              ...
              <div className="flex flex-col w-full md:w-6/12 gap-4">
                ...
                <div className="flex flex-col w-full justify-between   rounded-md">
                  ...
                  true ? <div className='p-3 bg-gray-100 shadow-lg shadow-gray-500/50'>
                      {/* <h3 className='text-gray-500 text-xl'>Chart</h3> */}
                      <hr className='w-full'/>
                      <ChartComponent title="CDOM Chart" data={data.CDOM} labels={data.week }/>
                ...
                <div className="flex flex-col w-full justify-between  rounded-md">
                  ...
                  </div>
                  {
                    true ? <div className='p-3 bg-gray-100 shadow-lg shadow-gray-500/50'>
                      {/* <h3 className='text-gray-500 text-xl'>Chart</h3> */}
                      <hr className='w-full'/>
                      <ChartComponent title="GCI Chart" data={data.GCI} labels={data.week}/>
                      <div className="group relative flex">
                        <svg data-tooltip-target="tooltip-hover" data-tooltip-trigger="click" className="h-6 w-8 text-red-400 ml-[85%] relative cursor-pointer" fill="none" viewBox="0 0 24 24" stroke="currentColor" onClick={toggleTooltip}>
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                        </svg><p className='text-red-400 flex justify-center cursor-pointer'>Info</p>
                ...
                <div className="flex flex-col w-full justify-between  rounded-md">
                  ...
                  </div>
                  {
                    true ? <div className='p-3 bg-gray-100 shadow-lg shadow-gray-500/50'>
                      {/* <h3 className='text-gray-500 text-xl'>Chart</h3> */}
                      <hr className='w-full'/>
                      <ChartComponent title="NDCI Chart" data={data.NDCI} labels={data.week}/>
                      <div className="group relative flex">
                        <svg data-tooltip-target="tooltip-hover" data-tooltip-trigger="click" className="h-6 w-8 text-red-400 ml-[85%] relative cursor-pointer" fill="none" viewBox="0 0 24 24" stroke="currentColor" onClick={toggleTooltip}>
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                        </svg><p className='text-red-400 flex justify-center cursor-pointer'>Info</p>
                ...
                <div className="flex flex-col w-full justify-between  rounded-md">
                  ...
                  </div>
                  {
                   true ? <div className='p-3 bg-gray-100 shadow-lg shadow-gray-500/50'>
                      {/* <h3 className='text-gray-500 text-xl'>Chart</h3> */}
                      <hr className='w-full'/>
                      <ChartComponent title="NDTI Chart" data={data.NDTI} labels={data.week}/>
                      <div className="group relative flex">
                        <svg data-tooltip-target="tooltip-hover" data-tooltip-trigger="click" className="h-6 w-8 text-red-400 ml-[85%] relative cursor-pointer" fill="none" viewBox="0 0 24 24" stroke="currentColor" onClick={toggleTooltip}>
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                        </svg><p className='text-red-400 flex justify-center cursor-pointer'>Info</p>
              ...
              <div className="flex flex-col w-full md:w-6/12 gap-4">
                <div className="flex flex-col w-full justify-between bg-gray-400 rounded-md">
                  ...
                  </div>
                  {
                    true? <div className='p-3 bg-gray-100 shadow-lg shadow-gray-500/50'>
                      {/* <h3 className='text-gray-500 text-xl'>Chart</h3> */}
                      <hr className='w-full'/>
                      <ChartComponent title="NDVI Chart" data={data.NDVI} labels={data.week}/>
                      <div className="group relative flex">
                        <svg data-tooltip-target="tooltip-hover" data-tooltip-trigger="click" className="h-6 w-8 text-red-400 ml-[85%] relative cursor-pointer" fill="none" viewBox="0 0 24 24" stroke="currentColor" onClick={toggleTooltip}>
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                        </svg><p className='text-red-400 flex justify-center cursor-pointer'>Info</p>
                ...
                <div className="flex flex-col w-full justify-between rounded-md">
                  ...
                  true ? <div className='p-3 bg-gray-100 shadow-lg shadow-gray-500/50'>
                      {/* <h3 className='text-gray-500 text-xl'>Chart</h3> */}
                      <hr className='w-full'/>
                      <ChartComponent title="TSS Chart" data={data.TSS} labels={data.week} />
                      <div className="group relative flex">
                        <svg data-tooltip-target="tooltip-hover" data-tooltip-trigger="click" className="h-6 w-8 text-red-400 ml-[85%] relative cursor-pointer" fill="none" viewBox="0 0 24 24" stroke="currentColor" onClick={toggleTooltip}>
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                        </svg><p className='text-red-400 flex justify-center cursor-pointer'>Info</p>
                ...
                <div className="flex flex-col w-full justify-between bg-gray-400 rounded-md">
                  ...
                  </div>
                  {
                    true ? <div className='p-3 bg-gray-100 shadow-lg shadow-gray-500/50'>
                      {/* <h3 className='text-gray-500 text-xl'>Chart</h3> */}
                      <hr className='w-full'/>
                      <ChartComponent title="NDWI Chart" data={data.NDWI} labels={data.week}/>
                      <div className="group relative flex">
                        <svg data-tooltip-target="tooltip-hover" data-tooltip-trigger="click" className="h-6 w-8 text-red-400 ml-[85%] relative cursor-pointer" fill="none" viewBox="0 0 24 24" stroke="currentColor" onClick={toggleTooltip}>
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                        </svg><p className='text-red-400 flex justify-center cursor-pointer'>Info</p>
