 ...
 useEffect(()=>{
  ...
  return (
    <Layout title={"User Pond Details"}>
      <div className='flex'>
        <aside style={{ backgroundColor: 'rgba(65, 148, 94, 1)' }} className=" hidden md:flex flex-col w-64 h-screen px-4 py-8 overflow-y-auto border-r rtl:border-r-0 rtl:border-l dark:bg-gray-900 dark:border-gray-700 lg:fixed">
          ...
          <div className="flex flex-col justify-between flex-1 mt-6 text-white">
            <nav>
              <div className="flex items-center px-4 py-2 text-gray-700 bg-gray-100 rounded-lg dark:bg-gray-800 dark:text-gray-200">
