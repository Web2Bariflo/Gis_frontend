  ...
  const handleUserLogin = async (e) => {
    ...
    try {
      ...
      const res = await axios.post(`${URL}/login/`, {
        identifier: e.target.phone.value,
      ...
      if (res.data && res.data.message) {
        ...
        if (
          res.data.message === "You are successfully entered the admin page..."
        ) {
  ...
  return (
    <Layout title={!isLogin ? "GIS Project Login" : "GIS Project Signup"}>
      {!isLogin ? (
        ...
        <section
          className="dark:bg-gray-900 h-screen"
          style={{
            background: "linear-gradient(to right, rgb(0, 101, 236), #94c1ff)",
          }}
        >
          <div
            className="dark:bg-gray-900 flex justify-center h-screen"
            style={{
              ...
              <div className="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
                <div className="p-6 space-y-4 md:space-y-6 sm:p-8 mb-0">
                  ...
                  <div>
                    ...
                    <p className="text-md font-semibold leading-tight tracking-tight text-black md:text-md dark:text-white text-center">
                      {t("AquaboticsAccount")}
                    </p>
                  </div>
                  <form
                  ...
                  >
                    ...
                    <div>
                      ...
                      {errors.email && (
                        <span className="text-sm font-light text-red-500">
                          {t("Email address must be in the format: example@example.com")}
                        </span>
                      )}
                    </div>
                    <div>
