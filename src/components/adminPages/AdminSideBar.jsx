            ...
            <div className='flex'>
                <aside style={{ backgroundColor: '#F6F8FC' }} className="hidden  md:flex flex-col w-64 h-screen px-4 py-8 overflow-y-auto border-r rtl:border-r-0 rtl:border-l dark:bg-gray-900 dark:border-gray-700">
                    ...
                    <div className="flex flex-col items-center mt-6 mx-1">
                        <Imgupload id={userId}/>
                        <h4 className="mx-2 mt-2 font-medium text-gray-600 dark:text-gray-200">{userName}</h4>
                    ...
                    <div className="flex flex-col justify-between flex-1 mt-6 text-gray-500">
                        <nav>
                            <div className={`flex items-center px-4 py-2 ${location.pathname === '/admin-dashboard' ? ' bg-gray-200  dark:text-gray-200 text-gray-700' : 'text-gray-500'} rounded-lg  dark:bg-gray-800 cursor-pointer`} onClick={()=>navigate('/admin-dashboard')}>
                            ...
                            <div className="flex items-center px-4 py-2 mt-5 text-gray-700 transition-colors duration-300 transform rounded-lg dark:text-gray-400 hover:bg-gray-200 dark:hover:bg-gray-800 dark:hover:text-gray-200 hover:text-gray-700 cursor-pointer" onClick={()=>navigate("/admin-cluster-view")}>
                                <svg className="w-5 h-5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div className="flex items-center px-4 py-2 mt-5 text-gray-700 transition-colors duration-300 transform rounded-lg dark:text-gray-400 hover:bg-gray-200 dark:hover:bg-gray-800 dark:hover:text-gray-200 hover:text-gray-700 cursor-pointer">
                                <svg className="w-5 h-5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
